        ...
        _factory = new WebApplicationFactory<Program>()
            .WithWebHostBuilder(builder =>
            {
                builder.ConfigureServices(services =>
                {
                    ...
                    {
                        options.DefaultAuthenticateScheme = "internal.bypass.authentication";
                        options.DefaultChallengeScheme = "internal.bypass.authentication";
                        options.DefaultScheme = "internal.bypass.authentication";
                    })
                    .AddScheme<AuthenticationSchemeOptions, BypassAuthenticationHandler>("internal.bypass.authentication", _ => { });

                    services.AddAuthorization(options =>
                    {
                        options.DefaultPolicy = new AuthorizationPolicyBuilder("internal.bypass.authentication")
